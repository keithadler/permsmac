...
enum TestKit {
    static var suites: [TestSuite] { [CatalogSuite.suite, TCCSuite.suite, HistorySuite.suite, StartupSuite.suite, CLISuite.suite, CleanupSuite.suite, AuditSuite.suite] }
