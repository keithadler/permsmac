...
enum Promo {
    @MainActor static func render(to dir: URL, screenshots: URL) throws -> [URL] {
        ...
        let cards: [(String, String, String, String?)] = [
            ...
            ("3-honest", "It reads. It never changes anything.", "One Full Disk Access grant so it can read the list. The switches stay in System Settings, one click away.", "camera.png"),
